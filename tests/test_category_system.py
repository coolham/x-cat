...
class TestContentCategorizer:
    ...
    async def test_categorize_with_ai(self, test_config, test_content):
        """测试AI分类"""
        # 设置模拟
        with patch('app.category_system.ai_categorizer.AICategorizer') as mock_ai:
...
class TestAICategorizer:
    ...
    async def test_categorize_success(self, test_content):
        """测试成功分类"""
        # 设置模拟
        with patch('app.category_system.ai_categorizer.AIClient') as mock_client:
            mock_instance = MagicMock()
...
class TestCustomCategorizer:
    ...
    def test_categorize_match(self, test_content):
        """测试匹配分类"""
        # 执行分类
        result = self.categorizer.categorize(test_content)
    ...
    def test_categorize_no_match(self):
        ...
        # 执行分类
        result = self.categorizer.categorize(content)
